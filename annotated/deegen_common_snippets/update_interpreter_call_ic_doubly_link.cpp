...
static void DeegenSnippet_UpdateInterpreterCallIcDoublyLink(HeapPtr<CodeBlock> calleeCbHeapPtr, uint8_t* doublyLink)
{
    ...
    HeapPtr<CodeBlock::InterpreterCallIcAnchor> cbAnchor = &calleeCbHeapPtr->m_interpreterCallIcList;
