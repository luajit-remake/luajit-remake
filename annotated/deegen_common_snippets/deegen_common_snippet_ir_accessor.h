...
extern std::unordered_map<std::string, const std::pair<const char* /*buffer*/, size_t /*length*/>*> g_deegenCommonSnippetLLVMIRMap;

inline std::unique_ptr<llvm::Module> WARN_UNUSED GetDeegenCommonSnippetLLVMIR(llvm::LLVMContext& ctx, const std::string& name)
{
