...
#define DEEGEN_COMMON_SNIPPET_NOOPT_VARNAME x_deegen_common_snippet_option_noopt
...
#define DEEGEN_COMMON_SNIPPET_OPTION_DO_NOT_OPTIMIZE_BEFORE_EXTRACT                                         \
    __attribute__((__used__)) inline constexpr bool DEEGEN_COMMON_SNIPPET_NOOPT_VARNAME = true;
