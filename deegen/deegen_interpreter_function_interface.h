...
public:
    ...
    static void CreateDispatchToCallee(llvm::Value* codePointer, llvm::Value* coroutineCtx, llvm::Value* preFixupStackBase, llvm::Value* numArgs, llvm::Value* calleeCodeBlockHeapPtr, llvm::Value* isMustTail, llvm::Instruction* insertBefore);
};
