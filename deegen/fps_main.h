...
inline cl::opt<std::string> cl_curSrcFileName("cur-src-filename", cl::desc("The C++ source file name for audit purpose"), cl::value_desc("filename"), cl::init(""), cl::cat(FPSOptions));
