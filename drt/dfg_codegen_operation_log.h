...
struct CodegenOperationLog
{
    ...
    void EmitMaterializeConstantLikeNodeToTempReg(Node* node)
    {
        ...
        CodegenOpRegAllocEnabled* op = m_log.Append<CodegenOpRegAllocEnabled>(m_alloc, CodegenOpRegAllocEnabled::ComputeAllocationSize(0 /*numInputOperands*/));
        ConstructInPlace(op);
    ...
    void EmitTypeCheck(DfgCodegenFuncOrd cgFnOrd, X64Reg opReg, RegAllocPassthruAndScratchRegInfo gprInfo, RegAllocPassthruAndScratchRegInfo fprInfo)
    {
        ...
        CodegenOpRegAllocEnabled* op = m_log.Append<CodegenOpRegAllocEnabled>(m_alloc, CodegenOpRegAllocEnabled::ComputeAllocationSize(1 /*numInputOperands*/));
        ConstructInPlace(op);
        op->m_nsd = nullptr;
...
private:
    struct LogBuffer
    {
        ...
        T* WARN_UNUSED Append(TempArenaAllocator& alloc, size_t numBytes)
        {
            ...
            m_length += numBytes;
            return std::launder(reinterpret_cast<T*>(res));
        }
