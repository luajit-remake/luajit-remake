...
// This table is generated by Deegen
//
...
BaselineCodeBlock* deegen_baseline_jit_do_codegen(CodeBlock* cb)
{
    ...
    // TODO: we need to account for the function entry logic
    //
    size_t fastPathCodeLen = 0;
    size_t slowPathCodeLen = 0;
    size_t dataSectionCodeLen = 0;
    ...
    // Set up the control struct and invoke the baseline JIT compiler implementation
    //
    {
        DeegenBaselineJitCodegenControlStruct ctl;
        ctl.m_jitFastPathAddr = fastPathSecPtr;
        ctl.m_jitSlowPathAddr = slowPathSecPtr;
        ctl.m_jitDataSecAddr = dataSecPtr;
